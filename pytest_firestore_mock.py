...
def pytest_configure(config):
    ...
    # Set dummy Firebase credentials
    os.environ["FIREBASE_TYPE"] = "service_account"
    os.environ["FIREBASE_PROJECT_ID"] = "test-project"
    os.environ["FIREBASE_PRIVATE_KEY_ID"] = "test-key-id"

    # Define the private key as a list of strings and join them.
    # This is a more robust way to define a multi-line string and avoids syntax errors.
    private_key_lines = [
        "-----BEGIN PRIVATE KEY-----",
